...
const CreateArticle = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await createArticle(cleanedData);
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-slate-50">Create New Article</h1>
                <p className="text-slate-400 mt-2">Fill in the details to publish a new defence article</p>
            </div>
            ...
            {success && (
                <div className="mb-6 p-4 bg-green-900/20 border border-green-500 rounded-lg flex items-start">
                    ...
                    <div>
                        <p className="text-green-300 font-medium">Article created successfully!</p>
